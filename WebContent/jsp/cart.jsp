		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:if test="${not empty cart.cartItems}">
								...
								<c:forEach items="${cart.cartItems }" var="caritem">
									<tr class="active">
										<td width="60" width="40%">
											<input type="hidden" name="id" value="22">
											<img src="${pageContext.request.contextPath}/${caritem.product.pimage}" width="70" height="60">
										</td>
										<td width="30%">
											<a target="_blank">${caritem.product.pname}</a>
										</td>
										<td width="20%">
											￥${caritem.product.shop_price}
										</td>
										<td width="10%">
											<input type="text" disabled="disabled" name="quantity" value="${caritem.count}" maxlength="4" size="10">
										</td>
										<td width="15%">
											<span class="subtotal">￥${caritem.subtotal}</span>
										</td>
										<td>
											<a href="${pageContext.request.contextPath }/cart?method=removeFromCart&pid=${caritem.product.pid}" class="delete">删除</a>
										</td>
									</tr>
								</c:forEach>
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath }/order?method=newOrder">
