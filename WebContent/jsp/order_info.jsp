...
<html>
	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								...
								<th colspan="2"><fmt:formatDate value="${order.ordertime}" pattern="yyyy-MM-dd HH:mm:ss" /> </th>
							</tr>
							<tr class="warning">
								<th>图片</th>
								<th>商品</th>
			...
			<div>
				<hr/>
				<form id="orderForm" action="${pageContext.request.contextPath}/order" method="get" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
